...
def banner():
    ...
    print GG+"  √=============================================√"
    print WW+"  |            MOD BY: RIAZ-KHAN        |"
    print GL+"  |             ♛┄┅════❁﷽❁════┅┄♛     |"
    print WW+"  |        TEAM : pakistani CYBER ErRoR SyStEm            |"
    print Y+"  |             TARGET: HACK KATLO SALE KI I'D       |"
    print GL+"  |-----------------RIAZ KHAN----------------------------|"
...
22222222222222222222     000000000     2222222222222222222222222222222222222222
                                                                               ...
                                                                               "
print GG+"╭────\033[91m[\033[96m RIAZ KHAN ID\033[95m / \033[96mUsername Target\033[91m ] "
...
def iqbalz(iqbalz_password):
  try:
	...
	if mask != login and (not 'login_attempt' in mask):
			...
			print "          P A S S W O R D  F I N D AB OPEN KAE "
                  	print RR+"+--♛┄┅════❁﷽❁════┅┄♛---------------------+"
